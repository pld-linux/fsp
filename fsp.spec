...
FSP jest zestawem programów, który implementuje protokół dostępu do
publicznych archiwów podobny do anonimowego FTP, ale z użyciem
protokołu UDP. Jego zamierzeniem nie jest zastępowanie FTP, ale
